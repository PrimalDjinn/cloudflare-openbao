/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cb9278a08f761421f3b882c2008a00dc)
// Runtime types generated with workerd@1.20260508.1 2026-05-13 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./dist/index");
		durableNamespaces: "BaoContainer";
	}
	interface Env {
		DB: D1Database;
        BAO_D1_CONNECTION_URL?: string | undefined;
		BAO_STATIC_SEAL_KEY: string;
		BAO_ADDR: string;
		SKIP_SETCAP: string;
		BAO_CONTAINER: DurableObjectNamespace<import("./dist/index").BaoContainer>;
	}
}
